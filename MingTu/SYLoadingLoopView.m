...
-(void)setUp
{
    ...
    self.roundDuration = 5;
    self.isDefaultEndAnimation = YES;
    [self setImage:[UIImage imageNamed:@"index.png"]];
    ...
    explosionCell.contents = (id)[UIImage imageNamed:@"snowflake1.png"].CGImage;
    ...
    UIImage *image = [UIImage imageNamed:@"snowflake1.png"];
