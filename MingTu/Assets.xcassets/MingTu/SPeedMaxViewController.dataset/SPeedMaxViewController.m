...
-(void)initMethod{
    ...
    /*
     ...
     showName = @"沁园春剃刀1:22";
     */
    NSDictionary *dic1 = @{@"title":@"沁园春剃刀1:22",@"imgename":@"Logo1.png",@"titleString":@"lh_qyc",@"detail":@"|收藏幸运|"};
    /*
     titleString = @"zzh_gumu";
     showName = @"熔岩古墓雷诺1:25";
     */
    NSDictionary *dic2 = @{@"title":@"熔岩古墓雷诺1:25",@"imgename":@"Logo2.png",@"titleString":@"zzh_gumu",@"detail":@"命徒丶张蔚然"};
